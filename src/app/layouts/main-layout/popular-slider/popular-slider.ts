...
export class PopularPeopleSlider {
  ...
  itemsPerSlide$ = this.breakpoint.observe([
    '(max-width: 400px)',
    '(max-width: 576px)',
    '(max-width: 800px)',
    '(max-width: 1000px)',
  ...
  constructor() {
    ...
    this.breakpoint.observe([
      ...
      else if (result.breakpoints['(max-width: 576px)']) this.itemsPerSlide = 2;
      else if (result.breakpoints['(max-width: 800px)']) this.itemsPerSlide = 3;
      else if (result.breakpoints['(max-width: 1000px)']) this.itemsPerSlide = 4;
      else if (result.breakpoints['(max-width: 1200px)']) this.itemsPerSlide = 5;
