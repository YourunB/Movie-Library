...
import { NowPlayingMoviesComponent } from "./layouts/main-layout/now-playing-movies/now-playing-movies";

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [Header, TradingMovies, PopularPeopleSlider, UpcomingMovies, NowPlayingMoviesComponent],
